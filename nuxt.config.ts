            ...
            meta: [
                {
                    name: 'description',
                    content:
                        'Primeira plataforma brasileira que unifica gestão acadêmica e corporativa de responsabilidade social. Centraliza, gerencia e mensura ações de empresas, ONGs, instituições de ensino e poder público!',
                },
                {
                    name: 'keywords',
                    content:
                        'responsabilidade social, ESG, transparência social, impacto social, sustentabilidade, Uninorte, Amazonas, ONGs, projetos sociais',
                },
                ...
                {property: 'og:image:type', content: 'image/png'},
                {
                    ...
                    content: 'Logo SerResponsável - Plataforma de Transparência Social',
                },
